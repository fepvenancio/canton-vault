# Canton Vault (`canton-vault`)

An enterprise-grade, privacy-preserving tokenized yield vault built natively for the **Canton Web3 Network** using Daml smart contracts and **CIP-0056 / CIP-0112 / CIP-0086** token interface standards.
...
2. **Inflation Protection ($10^3$ Virtual Share Offset)**:
   - Uses virtual offset math ($10^3$ virtual shares / $1$ virtual asset), rendering first-depositor share dilution and inflation attacks mathematically impossible.
